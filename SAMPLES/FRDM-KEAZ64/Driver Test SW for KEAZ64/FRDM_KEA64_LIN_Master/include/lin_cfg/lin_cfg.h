...
#else
/* Write the number of LIN interfaces that your device uses. */
#define LIN_NUM_OF_IFCS placeholder
#endif
...
#define UART_ADDR		 UART1_ADDR  //For slave
#else
 /* Define which UART to use on your board. */
#endif
