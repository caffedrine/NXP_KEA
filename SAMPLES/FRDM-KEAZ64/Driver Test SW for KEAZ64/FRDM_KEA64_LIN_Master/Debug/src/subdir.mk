...
src/FRDM_KEA64_LIN_Master.o: ../src/FRDM_KEA64_LIN_Master.c
	...
	arm-none-eabi-gcc "@src/FRDM_KEA64_LIN_Master.args" -MMD -MP -MF"$(@:%.o=%.d)" -MT"$@" -c -o "src/FRDM_KEA64_LIN_Master.o" "$<"
