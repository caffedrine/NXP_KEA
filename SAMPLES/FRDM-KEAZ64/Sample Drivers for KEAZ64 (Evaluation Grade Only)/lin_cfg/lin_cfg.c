...
#if LIN_MODE == _MASTER_MODE__
#if defined(MCU_SKEAZ1284) || defined(MCU_SKEAZN642)
const lin_hardware_name lin_virtual_ifc[LIN_NUM_OF_IFCS] = {uart1};
#else
/* Write the correct UART in use in your device for the array. */
const lin_hardware_name lin_virtual_ifc[LIN_NUM_OF_IFCS] = {/* UARTs your device uses. */ };
#endif
