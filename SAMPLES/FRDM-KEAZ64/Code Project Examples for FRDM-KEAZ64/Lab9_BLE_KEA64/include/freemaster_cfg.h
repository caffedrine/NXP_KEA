...
#define FMSTR_SCI_BASE         UART2_BASE_PTR   /* UART2 base on KEA */
#define FMSTR_SCI_INTERRUPT    UART2_IRQn       /* UART2  interrupt vector on KEA */

#define FMSTR_CAN_BASE         0x40024001u  /* MSCAN base on KEA */
#define FMSTR_CAN_INTERRUPT    30   /* MSCAN1 interrupt vector */
