...
/* Board used. KEAZ128 and KEAZ64 are the same silicon (SKEAZ1284), but the FRDM pinouts are different.
 * Change these values when you change boards. */

#define FRDM_KEAZ128 0
#define FRDM_KEAZ128_PROTOTYPE 0
#define FRDM_KEAZ64  1
#define FRDM_KEAZN32 0
...
#elif FRDM_KEAZ64 || FRDM_KEAZN32 || FRDM_KEAZ128_PROTOTYPE
...
/*Define these pinouts for your custom board if none of these three. */
...
#define		PA6				(AIN_C2)
#else
/* The Arduino headers for your device may map to different GPIO pins since it's different silicon. */
#endif
