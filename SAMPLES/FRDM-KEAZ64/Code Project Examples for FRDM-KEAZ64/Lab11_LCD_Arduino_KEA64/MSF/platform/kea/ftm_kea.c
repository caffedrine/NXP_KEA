	...
	if ( ftm->pins->pin[channel].pin_code != GPIO_INVALID_PIN)
	{
		...
		if (ftm->reg == FTM0)  // just 2 channels in FTM0
		{
			...
			case 0: // Set or clear FTM0PS0 flag in PINSEL0 
				...
				SIM_PINSEL = ftm->pins->pin[channel].alt_num ? SIM_PINSEL | SIM_PINSEL_FTM0PS0_MASK : SIM_PINSEL & ~SIM_PINSEL_FTM0PS0_MASK;
#else
#endif
				break;
...
#elif defined(MCU_SKEAZN642)
				SIM_PINSEL = ftm->pins->pin[channel].alt_num ? SIM_PINSEL | SIM_PINSEL_FTM0PS1_MASK : SIM_PINSEL & ~SIM_PINSEL_FTM0PS1_MASK;
#else
#endif
				break;
			}	
		...
		else if (ftm->reg == FTM1)
		{
			...
			case 0: // Set or clear FTM1PS0 flag in PINSEL0 
				...
				SIM_PINSEL = ftm->pins->pin[channel].alt_num ? SIM_PINSEL | SIM_PINSEL_FTM1PS0_MASK : SIM_PINSEL & ~SIM_PINSEL_FTM1PS0_MASK;
#else
#endif
				break;
...
#elif defined(MCU_SKEAZN642)
				SIM_PINSEL = ftm->pins->pin[channel].alt_num ? SIM_PINSEL | SIM_PINSEL_FTM1PS1_MASK : SIM_PINSEL & ~SIM_PINSEL_FTM1PS1_MASK;
#else
#endif
				break;
			}
...
#elif defined(MCU_SKEAZN642)
				SIM_PINSEL &=  ~ SIM_PINSEL_FTM2PS0_MASK ;			// clear fields
				SIM_PINSEL |= (ftm->pins->pin[channel].alt_num) << SIM_PINSEL_FTM2PS0_SHIFT ; 	// set fields according to the alt_num
#else
#endif
				break;
...
#elif defined(MCU_SKEAZN642)
				SIM_PINSEL &=  ~ SIM_PINSEL_FTM2PS1_MASK; 			// clear fields
				SIM_PINSEL |= (ftm->pins->pin[channel].alt_num) << SIM_PINSEL_FTM2PS1_SHIFT; 	// set fields according to the alt_num
#else
#endif
				break;
...
#elif defined(MCU_SKEAZN642)
				SIM_PINSEL &=  ~ SIM_PINSEL_FTM2PS2_MASK; 		// clear fields
				SIM_PINSEL |= (ftm->pins->pin[channel].alt_num) << SIM_PINSEL_FTM2PS2_SHIFT; 	// set fields according to the alt_num
#else
#endif
				break;
...
#elif defined(MCU_SKEAZN642)
				SIM_PINSEL &=  ~ SIM_PINSEL_FTM2PS3_MASK; 		// clear fields
				SIM_PINSEL |= (ftm->pins->pin[channel].alt_num) << SIM_PINSEL_FTM2PS3_SHIFT; 	// set fields according to the alt_num
#else
#endif
				break;
...
#elif defined(MCU_SKEAZN642)
				/* FTM2_CH4 exists on SKEAZN642 but no altpins. */
#else
#endif
				break;
...
#elif defined(MCU_SKEAZN642)
				/* FTM2_CH5 exists on SKEAZN642 but no altpins. */
#else
#endif
				break;
			}
