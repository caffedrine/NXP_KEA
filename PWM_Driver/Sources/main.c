...
void PWM__Init(FTM_Type *pFTM, uint32_t u32clock, uint32_t u32periodUS)
{
	/* SIM_SCGC: pFTM=1 */
...
int main()
{
	...
	/* Init pwm driver */
	PWM_Driver_Init( pFTM, 16000000/8 /*SysCLK in HZ*/, 1000 /*Period in US*/ );	// Period in microseconds
