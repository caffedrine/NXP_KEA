...
void PWM_Driver_Init(FTM_Type *pFTM, uint32_t u32clock, uint32_t u32periodUS)
{
	/* SIM_SCGC: pFTM=1 */
	...
	pFTM->MOD = FTM_MOD_MOD( u32clock / u32periodUS );
...
int main()
{
	...
	/* Init pwm driver */
	PWM_Driver_Init( pFTM, 16000000 /*SysCLK in HZ*/, 1000 /*Period in US*/ );	// Period in microseconds
